...
#define KERNEL_FILE "/home/daniel/Dropbox/opencl/opencl_regs/regs_kernel.cl"


//define some integer as refword for register values
#define REFWORD 0x00000000
//define how many times check the registers values. (number of tests)
#define NREPS 1
