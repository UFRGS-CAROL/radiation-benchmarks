...
from remote_sock_parameters import socketPort, sleepTime, serverIP, rebootingSleep, IPmachines, IPtoDiffReboot
from remote_sock_parameters import IPtoNames, IPtoSwitchIP, IPtoSwitchPort, SwitchIPtoModel, logFile
