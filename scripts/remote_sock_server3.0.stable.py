...
#	"192.168.1.6",  #CarolXeon1 NAO ESTA NO TESTE; USAR XEON2
#	"192.168.1.7",  #CarolXeon2 
#	"192.168.1.10", #CarolAPU1
#       "192.168.1.11", #CarolAPU2
#	"192.168.1.12", #CarolX1A AKA X1
#    	"192.168.1.13", #CarolX2A AKA X2
...
IPtoDiffReboot = {
	"192.168.1.1" : 50,  #CarolTitanX1
	"192.168.1.20" : 50,  #CarolK401
	"192.168.1.6" : 120, #CarolXeon1
	"192.168.1.7" : 200, #CarolXeon2
	"192.168.1.10" : 120, #CarolAPU1
	"192.168.1.11" : 50, #CarolAPU2
	"192.168.1.12" : 120, #CarolX2A
	"192.168.1.13" : 120, #CarolX2iB
        "192.168.1.15" : 120, #CarolTitanV1
        "192.168.1.16" : 120, #CarolTeslaV1001

}

# Set the machine names for each IP
IPtoNames = {
	"192.168.1.1" : "CarolV100",
	"192.168.1.20" : "CarolV2",
	"192.168.1.6" : "CarolXeon1",
	"192.168.1.7" : "CarolXeon2",
	"192.168.1.10" : "CarolAPU1",
	"192.168.1.11" : "CarolAPU2",
	"192.168.1.12" : "CarolX1A",
	"192.168.1.13" : "CarolTegraX2B",
        "192.168.1.15" : "CarolTitanV1",
        "192.168.1.16" : "CarolTeslaV1001",
}
...
IPtoSwitchIP = {
	"192.168.1.1" : "192.168.1.104",  #CarolTitanX1
	...
	"192.168.1.12" : "192.168.1.100", #CarolX2A
	"192.168.1.13" : "192.168.1.100", #CarolX2B
        "192.168.1.15" : "192.168.1.100", #CarolTitanV1
        "192.168.1.16" : "192.168.1.101", #CarolTeslaV1001
}
...
IPtoSwitchPort = {
	...
	"192.168.1.12" : 3, #CarolX2A AKA X1
	"192.168.1.13" : 4, #CarolX2B AKA X2
        "192.168.1.15" : 3, #CarolTitanV1
        "192.168.1.16" : 3, #CarolTeslaV1001 swap with TitanV1
...
def lindySwitch(portNumber, status, switchIP):
    ...
    try:
        ...
        logMsg("Could not change Lindy IP switch status, portNumber: "+str(portNumber)+", status"+status+", switchIP:"+switchIP)
        return 1
