...
#define LOOP_MUL {\
        value_int = 0x2; \
        asm volatile("vpbroadcastd %0, %%ymm4" :  : "m" (value_int) : "ymm4"); \
        asm volatile("vpbroadcastd %0, %%ymm5" :  : "m" (ref_int3) : "ymm5"); \
        \
        asm volatile("vpmulld %%ymm5, %%ymm4, %%ymm5" : : : "ymm4", "ymm5");\
        asm volatile("vpmulld %%ymm5, %%ymm4, %%ymm5" : : : "ymm4", "ymm5");\
        asm volatile("vpmulld %%ymm5, %%ymm4, %%ymm5" : : : "ymm4", "ymm5");\
        asm volatile("vpmulld %%ymm5, %%ymm4, %%ymm5" : : : "ymm4", "ymm5");\
        asm volatile("vpmulld %%ymm5, %%ymm4, %%ymm5" : : : "ymm4", "ymm5");\
        ...
        asm volatile("vpmulld %%ymm5, %%ymm4, %%ymm5" : : : "ymm4", "ymm5");\
        \
        asm volatile("vmovdqa32 %%ymm5, %0" : "=m" (vec_int[0]) : : "ymm5"); \
        DEBUG_INT \
...
int main (int argc, char *argv[]) {
    ...
    if (start_log_file("vmul_int", msg) != 0) {
        exit(EXIT_FAILURE);
    }
