...
#define LOOP_ADD {\
        value_int = 0; \
        asm volatile("vpbroadcastd %0, %%ymm2" :  : "m" (ref_int2) : "ymm2"); \
        asm volatile("vpbroadcastd %0, %%ymm3" :  : "m" (value_int) : "ymm3"); \
        \
        asm volatile("vpaddd %%ymm3, %%ymm2, %%ymm3" : : : "ymm2", "ymm3");\
        asm volatile("vpaddd %%ymm3, %%ymm2, %%ymm3" : : : "ymm2", "ymm3");\
        asm volatile("vpaddd %%ymm3, %%ymm2, %%ymm3" : : : "ymm2", "ymm3");\
        asm volatile("vpaddd %%ymm3, %%ymm2, %%ymm3" : : : "ymm2", "ymm3");\
        asm volatile("vpaddd %%ymm3, %%ymm2, %%ymm3" : : : "ymm2", "ymm3");\
        ...
        asm volatile("vpaddd %%ymm3, %%ymm2, %%ymm3" : : : "ymm2", "ymm3");\
        \
        asm volatile("vmovdqa32 %%ymm3, %0" : "=m" (vec_int[0]) : : "ymm3"); \
        DEBUG_INT \
...
int main (int argc, char *argv[]) {
    ...
    if (start_log_file("vadd_int", msg) != 0) {
        exit(EXIT_FAILURE);
    }
