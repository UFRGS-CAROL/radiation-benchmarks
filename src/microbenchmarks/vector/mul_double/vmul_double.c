...
#define LOOP_MUL {\
        value_fpd = 1.0; \
        asm volatile("vbroadcastsd %0, %%ymm4" :  : "m" (ref_fpd1) : "ymm4"); \
        asm volatile("vbroadcastsd %0, %%ymm5" :  : "m" (value_fpd) : "ymm5"); \
        \
        asm volatile("vmulpd %%ymm5, %%ymm4, %%ymm5" : : : "ymm4", "ymm5");\
        asm volatile("vmulpd %%ymm5, %%ymm4, %%ymm5" : : : "ymm4", "ymm5");\
        asm volatile("vmulpd %%ymm5, %%ymm4, %%ymm5" : : : "ymm4", "ymm5");\
        asm volatile("vmulpd %%ymm5, %%ymm4, %%ymm5" : : : "ymm4", "ymm5");\
        asm volatile("vmulpd %%ymm5, %%ymm4, %%ymm5" : : : "ymm4", "ymm5");\
        ...
        asm volatile("vmulpd %%ymm5, %%ymm4, %%ymm5" : : : "ymm4", "ymm5");\
        \
        asm volatile("vmovapd %%ymm5, %0" : "=m" (vec_fpd[0]) : : "ymm5");\
        DEBUG_FPD \
...
int main (int argc, char *argv[]) {
    ...
    if (start_log_file("vmul_double", msg) != 0) {
        exit(EXIT_FAILURE);
    }
