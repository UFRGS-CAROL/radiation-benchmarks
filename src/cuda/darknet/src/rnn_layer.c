...
void update_rnn_layer(layer l, int batch, float learning_rate, float momentum,
		float decay) {
...
{
	update_connected_layer_gpu(*(l.input_layer), batch, learning_rate, momentum, decay, stream);
	update_connected_layer_gpu(*(l.self_layer), batch, learning_rate, momentum, decay, stream);
	update_connected_layer_gpu(*(l.output_layer), batch, learning_rate, momentum, decay, stream);
}
