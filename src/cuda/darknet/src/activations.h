...
#ifdef GPU
void activate_array_ongpu(float *x, int n, ACTIVATION a, cudaStream_t stream);
void gradient_array_ongpu(float *x, int n, ACTIVATION a, float *delta, cudaStream_t stream);
#endif
