...
#define INPUT_A 42.0
#define INPUT_B 42.0
#define OUTPUT_R 176400000000.0
...
#ifdef LOGS
	char test_info[90];
	snprintf(test_info, 90, "ops:%d type:double-precision-triplicated", OPS);
	start_log_file((char *)"cuda_micro_dfma", test_info);
#endif
//====================================
