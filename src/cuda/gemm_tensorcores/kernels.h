...
//					read_voter_wmma_if(b0_frag , b1_frag, b2_frag, b0_frag.x, c0_frag.num_elements, is_memory_bad), acc_frag);
//
//
//
//		}
...
//				read_voter_wmma(c0_frag , c1_frag, c2_frag, c0_frag.x, is_memory_bad).x[i] = 
//						alpha * acc_frag.x[i] + beta * read_voter_wmma(c0_frag , c1_frag, c2_frag, c0_frag.x, is_memory_bad).x[i];
//
//			}
//
//			// Store the output
...
//			read_voter_wmma(*b_frag.x, b_frag.num_elements);
			read_voter_wmma(a_frag);
