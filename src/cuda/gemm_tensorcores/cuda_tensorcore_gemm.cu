...
__global__ void simple_wmma_gemm(half *a0, half *a1, half *a2, half *b0,
		half *b1, half *b2, tested_type *c, float *d0, float *d1, float *d2,
	...
	wmma::fragment<wmma::matrix_a0, WMMA_M, WMMA_N, WMMA_K, half,
			wmma::row_major> a0_frag;
	wmma::fragment<wmma::matrix_a1, WMMA_M, WMMA_N, WMMA_K, half,
			wmma::row_major> a1_frag;
	wmma::fragment<wmma::matrix_a2, WMMA_M, WMMA_N, WMMA_K, half,
			wmma::row_major> a2_frag;
	wmma::fragment<wmma::matrix_b0, WMMA_M, WMMA_N, WMMA_K, half,
			wmma::col_major> b0_frag;
	wmma::fragment<wmma::matrix_b1, WMMA_M, WMMA_N, WMMA_K, half,
			wmma::col_major> b1_frag;
	wmma::fragment<wmma::matrix_b2, WMMA_M, WMMA_N, WMMA_K, half,
...
_global__ void MatrixMulKernel(tested_type *d_A0, tested_type *d_A1,
	...
	((half2*)d_D0)[ty * (n / 2) + tx] = acc;
	((half2*)d_D1)[ty * (n / 2) + tx] = acc;
	((half2*)d_D2)[ty * (n / 2) + tx] = acc;
#endif
