...
ConvolutionalLayer::ConvolutionalLayer(size_t in_width, size_t in_height, size_t in_depth,
...
//          //return 3;
	...
	inline size_t ConvolutionalLayer::getOutIndex(size_t out, size_t h_, size_t w_) {
		return out * out_height_ * out_width_ + h_ * out_width_ + w_;
	}

	inline vec_t ConvolutionalLayer::getInforKernel(size_t in, size_t h_, size_t w_) {
		vec_t r;
