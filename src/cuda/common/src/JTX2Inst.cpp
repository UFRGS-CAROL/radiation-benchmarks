...
//	unsigned long rate;
	...
	char *benchmark_name = "Power_Temp_Current_Measurement";
	log_helper::start_log_file(benchmark_name, "");
...
//					convFromMilli * val, aunit);
			...
			str+= std::to_string(current_out) ; str+=  ";";
...
//					convFromMilli * val, vunit);
			...
			str+= std::to_string(voltage_out) ; str+=  ";";
