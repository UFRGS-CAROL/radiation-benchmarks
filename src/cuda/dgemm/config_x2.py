...
os.system("sudo ./generateMatrices -size=8192 -input_a=dgemmA_8192.matrix -input_b=dgemmB_8192.matrix -gold=dgemmGOLD_8192.matrix")
os.system("sudo chmod 777 dgemm*.matrix");
os.system("mv dgemm*.matrix "+data_path);
os.system("mv ./generateMatrices ./cudaDGEMM "+bin_path)
