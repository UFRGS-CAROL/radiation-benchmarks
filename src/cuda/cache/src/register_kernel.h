...
__global__ void test_register_file_kernel_or(uint32 *output_rf1, uint32 *output_rf2, uint32 *output_rf3, uint32 *trip_mem1, uint32 *trip_mem2, uint32 *trip_mem3, uint32 reg_data, const uint64 sleep_cycles) {
	...
	output_rf1[i + 186] = reg_data;
	output_rf2[i + 186] = reg_data;
	output_rf3[i + 186] = reg_data;

	output_rf1[i + 187] = reg_data;
	output_rf2[i + 187] = reg_data;
	output_rf3[i + 187] = reg_data;

	output_rf1[i + 188] = reg_data;
	output_rf2[i + 188] = reg_data;
	output_rf3[i + 188] = reg_data;

	output_rf1[i + 189] = reg_data;
	output_rf2[i + 189] = reg_data;
	output_rf3[i + 189] = reg_data;

	output_rf1[i + 190] = reg_data;
	output_rf2[i + 190] = reg_data;
	output_rf3[i + 190] = reg_data;

	output_rf1[i + 191] = reg_data;
	output_rf2[i + 191] = reg_data;
	output_rf3[i + 191] = reg_data;

	output_rf1[i + 192] = reg_data;
	output_rf2[i + 192] = reg_data;
	output_rf3[i + 192] = reg_data;

	output_rf1[i + 193] = reg_data;
	output_rf2[i + 193] = reg_data;
	output_rf3[i + 193] = reg_data;

	output_rf1[i + 194] = reg_data;
	output_rf2[i + 194] = reg_data;
	output_rf3[i + 194] = reg_data;

	output_rf1[i + 195] = reg_data;
	output_rf2[i + 195] = reg_data;
	output_rf3[i + 195] = reg_data;

	output_rf1[i + 196] = reg_data;
	output_rf2[i + 196] = reg_data;
	output_rf3[i + 196] = reg_data;

	output_rf1[i + 197] = reg_data;
	output_rf2[i + 197] = reg_data;
	output_rf3[i + 197] = reg_data;

	output_rf1[i + 198] = reg_data;
	output_rf2[i + 198] = reg_data;
	output_rf3[i + 198] = reg_data;

	output_rf1[i + 199] = reg_data;
	output_rf2[i + 199] = reg_data;
	output_rf3[i + 199] = reg_data;

	output_rf1[i + 200] = reg_data;
	output_rf2[i + 200] = reg_data;
	output_rf3[i + 200] = reg_data;

	output_rf1[i + 201] = reg_data;
	output_rf2[i + 201] = reg_data;
	output_rf3[i + 201] = reg_data;

	output_rf1[i + 202] = reg_data;
	output_rf2[i + 202] = reg_data;
	output_rf3[i + 202] = reg_data;

	output_rf1[i + 203] = reg_data;
	output_rf2[i + 203] = reg_data;
	output_rf3[i + 203] = reg_data;

	output_rf1[i + 204] = reg_data;
	output_rf2[i + 204] = reg_data;
	output_rf3[i + 204] = reg_data;

	output_rf1[i + 205] = reg_data;
	output_rf2[i + 205] = reg_data;
	output_rf3[i + 205] = reg_data;

	output_rf1[i + 206] = reg_data;
	output_rf2[i + 206] = reg_data;
	output_rf3[i + 206] = reg_data;

	output_rf1[i + 207] = reg_data;
	output_rf2[i + 207] = reg_data;
	output_rf3[i + 207] = reg_data;

	output_rf1[i + 208] = reg_data;
	output_rf2[i + 208] = reg_data;
	output_rf3[i + 208] = reg_data;

	output_rf1[i + 209] = reg_data;
	output_rf2[i + 209] = reg_data;
	output_rf3[i + 209] = reg_data;

	output_rf1[i + 210] = reg_data;
	output_rf2[i + 210] = reg_data;
	output_rf3[i + 210] = reg_data;

	output_rf1[i + 211] = reg_data;
	output_rf2[i + 211] = reg_data;
	output_rf3[i + 211] = reg_data;

	output_rf1[i + 212] = reg_data;
	output_rf2[i + 212] = reg_data;
	output_rf3[i + 212] = reg_data;

	output_rf1[i + 213] = reg_data;
	output_rf2[i + 213] = reg_data;
	output_rf3[i + 213] = reg_data;

	output_rf1[i + 214] = reg_data;
	output_rf2[i + 214] = reg_data;
	output_rf3[i + 214] = reg_data;

	output_rf1[i + 215] = reg_data;
	output_rf2[i + 215] = reg_data;
	output_rf3[i + 215] = reg_data;

	output_rf1[i + 216] = reg_data;
	output_rf2[i + 216] = reg_data;
	output_rf3[i + 216] = reg_data;

	output_rf1[i + 217] = reg_data;
	output_rf2[i + 217] = reg_data;
	output_rf3[i + 217] = reg_data;

	output_rf1[i + 218] = reg_data;
	output_rf2[i + 218] = reg_data;
	output_rf3[i + 218] = reg_data;

	output_rf1[i + 219] = reg_data;
	output_rf2[i + 219] = reg_data;
	output_rf3[i + 219] = reg_data;

	output_rf1[i + 220] = reg_data;
	output_rf2[i + 220] = reg_data;
	output_rf3[i + 220] = reg_data;

	output_rf1[i + 221] = reg_data;
	output_rf2[i + 221] = reg_data;
	output_rf3[i + 221] = reg_data;

	output_rf1[i + 222] = reg_data;
	output_rf2[i + 222] = reg_data;
	output_rf3[i + 222] = reg_data;

	output_rf1[i + 223] = reg_data;
	output_rf2[i + 223] = reg_data;
	output_rf3[i + 223] = reg_data;

	output_rf1[i + 224] = reg_data;
	output_rf2[i + 224] = reg_data;
	output_rf3[i + 224] = reg_data;

	output_rf1[i + 225] = reg_data;
	output_rf2[i + 225] = reg_data;
	output_rf3[i + 225] = reg_data;

	output_rf1[i + 226] = reg_data;
	output_rf2[i + 226] = reg_data;
	output_rf3[i + 226] = reg_data;

	output_rf1[i + 227] = reg_data;
	output_rf2[i + 227] = reg_data;
	output_rf3[i + 227] = reg_data;

	output_rf1[i + 228] = reg_data;
	output_rf2[i + 228] = reg_data;
	output_rf3[i + 228] = reg_data;

	output_rf1[i + 229] = reg_data;
	output_rf2[i + 229] = reg_data;
	output_rf3[i + 229] = reg_data;

	output_rf1[i + 230] = reg_data;
	output_rf2[i + 230] = reg_data;
	output_rf3[i + 230] = reg_data;

	output_rf1[i + 231] = reg_data;
	output_rf2[i + 231] = reg_data;
	output_rf3[i + 231] = reg_data;

	output_rf1[i + 232] = reg_data;
	output_rf2[i + 232] = reg_data;
	output_rf3[i + 232] = reg_data;

	output_rf1[i + 233] = reg_data;
	output_rf2[i + 233] = reg_data;
	output_rf3[i + 233] = reg_data;

	output_rf1[i + 234] = reg_data;
	output_rf2[i + 234] = reg_data;
	output_rf3[i + 234] = reg_data;

	output_rf1[i + 235] = reg_data;
	output_rf2[i + 235] = reg_data;
	output_rf3[i + 235] = reg_data;

	output_rf1[i + 236] = reg_data;
	output_rf2[i + 236] = reg_data;
	output_rf3[i + 236] = reg_data;

	output_rf1[i + 237] = reg_data;
	output_rf2[i + 237] = reg_data;
	output_rf3[i + 237] = reg_data;

	output_rf1[i + 238] = reg_data;
	output_rf2[i + 238] = reg_data;
	output_rf3[i + 238] = reg_data;

	output_rf1[i + 239] = reg_data;
	output_rf2[i + 239] = reg_data;
	output_rf3[i + 239] = reg_data;

	output_rf1[i + 240] = reg_data;
	output_rf2[i + 240] = reg_data;
	output_rf3[i + 240] = reg_data;

	output_rf1[i + 241] = reg_data;
	output_rf2[i + 241] = reg_data;
	output_rf3[i + 241] = reg_data;

	output_rf1[i + 242] = reg_data;
	output_rf2[i + 242] = reg_data;
	output_rf3[i + 242] = reg_data;

	output_rf1[i + 243] = reg_data;
	output_rf2[i + 243] = reg_data;
	output_rf3[i + 243] = reg_data;

	output_rf1[i + 244] = reg_data;
	output_rf2[i + 244] = reg_data;
	output_rf3[i + 244] = reg_data;

	output_rf1[i + 245] = reg_data;
	output_rf2[i + 245] = reg_data;
	output_rf3[i + 245] = reg_data;

	output_rf1[i + 246] = reg_data;
	output_rf2[i + 246] = reg_data;
	output_rf3[i + 246] = reg_data;

	output_rf1[i + 247] = reg_data;
	output_rf2[i + 247] = reg_data;
	output_rf3[i + 247] = reg_data;

	output_rf1[i + 248] = reg_data;
	output_rf2[i + 248] = reg_data;
	output_rf3[i + 248] = reg_data;

	output_rf1[i + 249] = reg_data;
	output_rf2[i + 249] = reg_data;
	output_rf3[i + 249] = reg_data;

	output_rf1[i + 250] = reg_data;
	output_rf2[i + 250] = reg_data;
	output_rf3[i + 250] = reg_data;

	output_rf1[i + 251] = reg_data;
	output_rf2[i + 251] = reg_data;
	output_rf3[i + 251] = reg_data;

	output_rf1[i + 252] = reg_data;
	output_rf2[i + 252] = reg_data;
	output_rf3[i + 252] = reg_data;

	output_rf1[i + 253] = reg_data;
	output_rf2[i + 253] = reg_data;
	output_rf3[i + 253] = reg_data;

	output_rf1[i + 254] = reg_data;
	output_rf2[i + 254] = reg_data;
	output_rf3[i + 254] = reg_data;

	output_rf1[i + 255] = reg_data;
	output_rf2[i + 255] = reg_data;
	output_rf3[i + 255] = reg_data;
