...
__global__ void lud_diagonal(double *m, int matrix_dim, int offset) {
	int i, j;
...
__global__ void lud_perimeter(double *m, int matrix_dim, int offset) {
...
__global__ void lud_internal(double *m, int matrix_dim, int offset) {
	__shared__ double peri_row[BLOCK_SIZE][BLOCK_SIZE];
	__shared__ double peri_col[BLOCK_SIZE][BLOCK_SIZE];
