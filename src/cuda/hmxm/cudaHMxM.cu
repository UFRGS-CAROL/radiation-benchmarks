...
//================== Read test parameters
    ...
    else
    {
        ...
        snprintf(a_matrix_path, 100, "hmxm_a_%i.matrix", (signed int)DEFAULT_INPUT_SIZE);
    ...
    else
    {
        ...
        snprintf(b_matrix_path, 100, "hmxm_b_%i.matrix", (signed int)DEFAULT_INPUT_SIZE);
        printf("Using default input_a path: %s\n", b_matrix_path);
    }
    ...
    else
    {
        ...
        snprintf(gold_matrix_path, 100, "hmxm_gold_%i.matrix", (signed int)k);
