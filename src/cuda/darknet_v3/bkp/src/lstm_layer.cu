...
layer make_lstm_layer(int batch, int inputs, int outputs, int steps,
	...
	*(l.wo) = make_connected_layer(batch * steps, outputs, outputs, LINEAR,
	...
	l.prev_state_cpu = (real_t*) calloc(batch * outputs, sizeof(real_t));
	l.prev_cell_cpu = (real_t*) calloc(batch * outputs, sizeof(real_t));
	l.cell_cpu = (real_t*) calloc(batch * outputs * steps, sizeof(real_t));

	l.f_cpu = (real_t*) calloc(batch * outputs, sizeof(real_t));
	l.i_cpu = (real_t*) calloc(batch * outputs, sizeof(real_t));
	l.g_cpu = (real_t*) calloc(batch * outputs, sizeof(real_t));
	l.o_cpu = (real_t*) calloc(batch * outputs, sizeof(real_t));
	l.c_cpu = (real_t*) calloc(batch * outputs, sizeof(real_t));
	l.h_cpu = (real_t*) calloc(batch * outputs, sizeof(real_t));
	l.temp_cpu = (real_t*) calloc(batch * outputs, sizeof(real_t));
	l.temp2_cpu = (real_t*) calloc(batch * outputs, sizeof(real_t));
	l.temp3_cpu = (real_t*) calloc(batch * outputs, sizeof(real_t));
	l.dc_cpu = (real_t*) calloc(batch * outputs, sizeof(real_t));
	l.dh_cpu = (real_t*) calloc(batch * outputs, sizeof(real_t));
