...
__global__ void binarize_input_kernel(real_t *input, int n, int size, real_t *binary)
{
...
__global__ void binarize_weights_kernel(real_t *weights, int n, int size, real_t *binary)
{
...
void forward_convolutional_layer_gpu(convolutional_layer l, network net)
{
    ...
    for(i = 0; i < l.batch; ++i){
        for(j = 0; j < l.groups; ++j){
            ...
            real_t *im = net.input_gpu + (i*l.groups + j)*l.c/l.groups*l.h*l.w;
...
__global__ void smooth_kernel(real_t *x, int n, int w, int h, int c, int size, real_t rate, real_t *delta)
{
...
void backward_convolutional_layer_gpu(convolutional_layer l, network net)
{
    ...
    for(i = 0; i < l.batch; ++i){
        for(j = 0; j < l.groups; ++j){
            ...
            real_t *im  = net.input_gpu+(i*l.groups + j)*l.c/l.groups*l.h*l.w;
            real_t *imd = net.delta_gpu+(i*l.groups + j)*l.c/l.groups*l.h*l.w;
