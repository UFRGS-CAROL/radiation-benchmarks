...
static void dump_output(int iteration_num, std::string directory,
		bool corrupted, std::vector<std::vector<int> > data) {
	char filename[100];
...
static bool set_countains(std::vector<int> check,
