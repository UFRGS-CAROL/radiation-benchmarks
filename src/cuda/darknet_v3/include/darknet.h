...
void normalize_cpu(real_t *x, real_t *mean, real_t *variance, int batch, int filters, int spatial);
...
void demo(char *cfgfile, char *weightfile, real_t thresh, int cam_index, const char *filename, char **names, int classes, int frame_skip, char *prefix, int avg, real_t hier_thresh, int w, int h, int fps, int fullscreen);
void get_detection_detections(layer l, int w, int h, real_t thresh, detection *dets);
...
int get_yolo_detections(layer l, int w, int h, int netw, int neth, real_t thresh, int *map, int relative, detection *dets);
...
void draw_box_width(image a, int x1, int y1, int x2, int y2, int w, real_t r, real_t g, real_t b);
...
void random_distort_image(image im, real_t hue, real_t saturation, real_t exposure);
...
void draw_detections(image im, detection *dets, int num, real_t thresh, char **names, image **alphabet, int classes);
...
void hierarchy_predictions(real_t *predictions, int n, tree *hier, int only_leaves, int stride);
