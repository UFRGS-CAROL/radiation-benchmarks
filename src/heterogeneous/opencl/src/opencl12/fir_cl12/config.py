...
os.system("cd "+src_fir+"; sudo ./fir_cl20 -b 2048 -d 2048 -g");
os.system("cd "+src_fir+"; sudo ./fir_cl20 -b 4096 -d 4096 -g");
os.system("cd "+src_fir+"; sudo ./fir_cl20 -b 8192 -d 8192 -g");
os.system("sudo chmod 777 input output input/* output/* ");
os.system("mv input output "+data_path);
os.system("mv ./fir_cl20 "+bin_path);
os.system("cp run_* "+bin_path);

fp = open(installDir+"scripts/how_to_run_fir_cl20", 'w')
...
print "\nConfiguring done, to run check file: "+installDir+"scripts/how_to_run_fir_cl20\n"
