...
/* THIS FILE:  /home/carol/vinicius/radiation-benchmarks/src/heterogeneous/hsa/src/hsa/page_rank_hsa/kernels.h  */
/* INPUT FILE: /home/carol/vinicius/radiation-benchmarks/src/heterogeneous/hsa/src/hsa/page_rank_hsa/kernels.cl  */
#ifdef __cplusplus
...
#define __SNK_DEFS
#endif
extern _CPPSTRING_ void pageRank_kernel(int num_rows,int* rowOffset,int* col,float* val,size_t vals_size,float* x,float* y, const snk_lparm_t * lparm);
