/* HEADER FILE GENERATED BY snack VERSION 0.9.3 */
/* THIS FILE:  /home/ckalra/Hetero-Mark/src/hsa/kmeans_hsa/kernels.h  */
/* INPUT FILE: /home/ckalra/Hetero-Mark/src/hsa/kmeans_hsa/kernels.cl  */
#ifdef __cplusplus
...
#define __SNK_DEFS
#endif
extern _CPPSTRING_ void kmeans_kernel_c(float* feature,float* clusters,int* membership,int npoints,int nclusters,int nfeatures,int offset,int size,unsigned int* errorBuffer, const snk_lparm_t * lparm);
extern _CPPSTRING_ void kmeans_kernel_c_init(const int printStats);
extern _CPPSTRING_ void kmeans_swap(float* feature,float* feature_swap,int npoints,int nfeatures,unsigned int* errorBuffer, const snk_lparm_t * lparm);
