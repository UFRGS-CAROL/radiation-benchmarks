...
/* THIS FILE:  /home/carol/vinicius/radiation-benchmarks/src/heterogeneous/hsa_rmt/src/hsa/page_rank_inter_errinj/kernels.h  */
/* INPUT FILE: /home/carol/vinicius/radiation-benchmarks/src/heterogeneous/hsa_rmt/src/hsa/page_rank_inter_errinj/kernels.cl  */
#ifdef __cplusplus
...
#define __SNK_DEFS
#endif
extern _CPPSTRING_ void pageRank_kernel(int num_rows,int* rowOffset,int* col,float* val,size_t vals_size,float* x,float* y,int* lockBuffer,unsigned int* errorBuffer,unsigned int* addressBuffer,unsigned long* valueBuffer,unsigned int* groupID, const snk_lparm_t * lparm);
extern _CPPSTRING_ void pageRank_kernel_init(const int printStats);
