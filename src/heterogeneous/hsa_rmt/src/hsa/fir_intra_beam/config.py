...
print >>fp, "cd "+bin_path+"; bash "+bin_path+"/run_fir_intra_beam_2048.sh"
print >>fp, "cd "+bin_path+"; bash "+bin_path+"/run_fir_intra_beam_4096.sh"
print >>fp, "cd "+bin_path+"; bash "+bin_path+"/run_fir_intra_beam_8192.sh"
