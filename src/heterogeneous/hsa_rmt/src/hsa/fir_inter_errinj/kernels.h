...
/* THIS FILE:  /home/carol/vinicius/radiation-benchmarks/src/heterogeneous/hsa_rmt/src/hsa/fir_inter_errinj/kernels.h  */
/* INPUT FILE: /home/carol/vinicius/radiation-benchmarks/src/heterogeneous/hsa_rmt/src/hsa/fir_inter_errinj/kernels.cl  */
#ifdef __cplusplus
...
#define __SNK_DEFS
#endif
extern _CPPSTRING_ void FIR(float* output,float* coeff,float* temp_input,unsigned int numTap,int* lockBuffer,unsigned int* errorBuffer,unsigned int* addressBuffer,unsigned long* valueBuffer,unsigned int* groupID, const snk_lparm_t * lparm);
