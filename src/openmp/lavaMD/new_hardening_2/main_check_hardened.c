...
int main( int argc, char *argv [])
{
    ...
    int i, j, k_hardened_1, k_hardened_2, l, m, n;
                ...
                for(l=-1; l<2; l++) {
                    ...
                    for(m=-1; m<2; m++) {
                        ...
                        for(n=-1; n<2; n++) {
                            ...
                            if((((i+l)>=0 && (j+m)>=0 && (READ_HARDENED_VAR_INT(k_hardened_1, k_hardened_2, "k")+n)>=0)==true && ((i+l)<dim_cpu.boxes1d_arg && (j+m)<dim_cpu.boxes1d_arg && (READ_HARDENED_VAR_INT(k_hardened_1, k_hardened_2, "k")+n)<dim_cpu.boxes1d_arg)==true) && (l==0 && m==0 && n==0)==false) {

                                box_cpu[nh].nei[box_cpu[nh].nn].x = (READ_HARDENED_VAR_INT(k_hardened_1, k_hardened_2, "k")+n);
