...
int main( int argc, char *argv [])
{
    ...
    int i, j, k_hardened_1, k_hardened_2, l, m, n_hardened_1, n_hardened_2;
    ...
    for(i=0; i<dim_cpu.boxes1d_arg; i++) {
        ...
        for(j=0; j<dim_cpu.boxes1d_arg; j++) {
            ...
            for(k_hardened_1=0, k_hardened_2=0; READ_HARDENED_VAR_INT(k_hardened_1, k_hardened_2, "k")<dim_cpu.boxes1d_arg; k_hardened_1++, k_hardened_2++) {
                box_cpu[nh].x = READ_HARDENED_VAR_INT(k_hardened_1, k_hardened_2, "k");
                box_cpu[nh].y = j;
                box_cpu[nh].z = i;
                ...
                for(l=-1; l<2; l++) {
                    ...
                    for(m=-1; m<2; m++) {
                        ...
                        for(n_hardened_1=-1, n_hardened_2=-1; READ_HARDENED_VAR_INT(n_hardened_1, n_hardened_2, "n")<2; n_hardened_1++, n_hardened_2++) {

                            if((((i+l)>=0 && (j+m)>=0 && (READ_HARDENED_VAR_INT(k_hardened_1, k_hardened_2, "k")+READ_HARDENED_VAR_INT(n_hardened_1, n_hardened_2, "n"))>=0)==true && ((i+l)<dim_cpu.boxes1d_arg && (j+m)<dim_cpu.boxes1d_arg && (READ_HARDENED_VAR_INT(k_hardened_1, k_hardened_2, "k")+READ_HARDENED_VAR_INT(n_hardened_1, n_hardened_2, "n"))<dim_cpu.boxes1d_arg)==true) && (l==0 && m==0 && READ_HARDENED_VAR_INT(n_hardened_1, n_hardened_2, "n")==0)==false) {

                                box_cpu[nh].nei[box_cpu[nh].nn].x = (READ_HARDENED_VAR_INT(k_hardened_1, k_hardened_2, "k")+READ_HARDENED_VAR_INT(n_hardened_1, n_hardened_2, "n"));
