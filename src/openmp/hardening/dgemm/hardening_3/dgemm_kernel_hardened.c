                ...
                for(ii = 0; ii < order; ii+=block) {
                    ...
                    for (kg_hardened_1=kk,kg_hardened_2=kk,k=0; READ_HARDENED_VAR_INT(kg_hardened_1, kg_hardened_2, "kg")<MIN(kk+block,order); k++,kg_hardened_1++,kg_hardened_2++)
                        for (ig_hardened_1=ii,ig_hardened_2=ii,i=0; READ_HARDENED_VAR_INT(ig_hardened_1, ig_hardened_2, "ig")<MIN(ii+block,order); i++,ig_hardened_1++,ig_hardened_2++)
                            AA_arr(i,k) = A_arr(READ_HARDENED_VAR_INT(ig_hardened_1, ig_hardened_2, "ig"),READ_HARDENED_VAR_INT(kg_hardened_1, kg_hardened_2, "kg"));
                    ...
                    for (jg_hardened_1=jj,jg_hardened_2=jj,j=0; READ_HARDENED_VAR_INT(jg_hardened_1, jg_hardened_2, "jg")<MIN(jj+block,order); j++,jg_hardened_1++,jg_hardened_2++)
                        for (ig_hardened_1=ii,ig_hardened_2=ii,i=0; READ_HARDENED_VAR_INT(ig_hardened_1, ig_hardened_2, "ig")<MIN(ii+block,order); i++,ig_hardened_1++,ig_hardened_2++)
                            C_arr(READ_HARDENED_VAR_INT(ig_hardened_1, ig_hardened_2, "ig"),READ_HARDENED_VAR_INT(jg_hardened_1, jg_hardened_2, "jg")) += CC_arr(i,j);
