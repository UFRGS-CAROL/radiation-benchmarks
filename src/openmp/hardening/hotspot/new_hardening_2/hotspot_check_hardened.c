...
int main(int argc, char **argv)
{
...
#endif
    int grid_rows_hardened_1, grid_rows_hardened_2, grid_cols, sim_time, i;
    ...
    temp = (FLOAT *) calloc (READ_HARDENED_VAR_INT(grid_rows_hardened_1, grid_rows_hardened_2, "grid_rows") * grid_cols, sizeof(FLOAT));
    power = (FLOAT *) calloc (READ_HARDENED_VAR_INT(grid_rows_hardened_1, grid_rows_hardened_2, "grid_rows") * grid_cols, sizeof(FLOAT));
    result = (FLOAT *) calloc (READ_HARDENED_VAR_INT(grid_rows_hardened_1, grid_rows_hardened_2, "grid_rows") * grid_cols, sizeof(FLOAT));
    gold = (FLOAT *) calloc (READ_HARDENED_VAR_INT(grid_rows_hardened_1, grid_rows_hardened_2, "grid_rows") * grid_cols, sizeof(FLOAT));
    if(!temp || !power)
        fatal("unable to allocate memory");

#ifdef LOGS
    char test_info[100];
    snprintf(test_info, 100, "simIter:%d gridSize:%dx%d",sim_time, READ_HARDENED_VAR_INT(grid_rows_hardened_1, grid_rows_hardened_2, "grid_rows"), grid_cols);
    ...
    read_input(temp, READ_HARDENED_VAR_INT(grid_rows_hardened_1, grid_rows_hardened_2, "grid_rows"), grid_cols, tfile);
    read_input(power, READ_HARDENED_VAR_INT(grid_rows_hardened_1, grid_rows_hardened_2, "grid_rows"), grid_cols, pfile);
    read_input(gold, READ_HARDENED_VAR_INT(grid_rows_hardened_1, grid_rows_hardened_2, "grid_rows"), grid_cols, ofile);
    ...
    for (loop1=0; loop1 < tot_iterations; loop1++)
    {
        ...
        compute_tran_temp(result,sim_time, temp, power, READ_HARDENED_VAR_INT(grid_rows_hardened_1, grid_rows_hardened_2, "grid_rows"), grid_cols);
