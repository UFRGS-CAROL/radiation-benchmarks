...
NUM_THREADS = 4
INPUT_SIZE = 1048576
INPUT_FILE = "/home/carol/radiation-benchmarks/src/openmp/selective_hardening/codes/mergesort/hardened_1/inputsort_" + str(INPUT_SIZE)
GOLD_FILE = "/home/carol/radiation-benchmarks/src/openmp/selective_hardening/codes/mergesort/hardened_1/gold_" + str(INPUT_SIZE)
ITERATIONS = 100000

def config(board, debug):

    benchmark_bin = "merge_check_hardened_1"
    ...
    src_benchmark = install_dir + "src/openmp/selective_hardening/codes/mergesort/hardened_1"
    ...
    generate = ["sudo mkdir -p " + bin_path,
                ...
                "sudo mv -f /home/carol/radiation-benchmarks/src/openmp/selective_hardening/codes/mergesort/hardened_1/" + benchmark_bin + " " + bin_path + "/",
                "make clean"]
