                      ...
                      FLOAT step)
{
    ...
    #pragma omp parallel for shared(power, temp, result) private(chunk, r_hardened_1, r_hardened_2, c, delta) firstprivate(row, col, num_chunk, chunks_in_row) schedule(static)
#endif
...
int main(int argc, char **argv)
{
    ...
    start_log_file((char *)"openMPDHotspot_SH_hardened_3", test_info);
