...
NUM_THREADS = 4
INPUT_SIZE = 2097152
INPUT_FILE = "/home/carol/radiation-benchmarks/src/openmp/selective_hardening/codes/quicksort/hardened_1/inputsort_" + str(INPUT_SIZE)
GOLD_FILE = "/home/carol/radiation-benchmarks/src/openmp/selective_hardening/codes/quicksort/hardened_1/gold_" + str(INPUT_SIZE)
ITERATIONS = 100000

def config(board, debug):

    benchmark_bin = "quick_check_hardened_1"
    ...
    src_benchmark = install_dir + "src/openmp/selective_hardening/codes/quicksort/hardened_1"
