...
def config(board, debug):
    ...
    benchmark_bin = "quick_check_not_hardened"
    ...
    src_benchmark = install_dir + "src/openmp/selective_hardening/codes/quicksort/not_hardened"
    ...
    generate = ["sudo mkdir -p " + bin_path,
                ...
                "sudo mv -f /home/carol/radiation-benchmarks/src/openmp/selective_hardening/codes/quicksort/not_hardened/" + benchmark_bin + " " + bin_path + "/",
                "make clean"]
