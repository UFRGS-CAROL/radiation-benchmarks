...
NUM_THREADS = 4
INPUT_SIZE = 2097152
INPUT_FILE = "/home/carol/radiation-benchmarks/src/openmp/selective_hardening/codes/quicksort/hardened_2/inputsort_" + str(INPUT_SIZE)
GOLD_FILE = "/home/carol/radiation-benchmarks/src/openmp/selective_hardening/codes/quicksort/hardened_2/gold_" + str(INPUT_SIZE)
ITERATIONS = 100000
...
def config(board, debug):
    ...
    generate = ["sudo mkdir -p " + bin_path,
                ...
                "sudo mv -f /home/carol/radiation-benchmarks/src/openmp/selective_hardening/codes/quicksort/hardened_2/" + benchmark_bin + " " + bin_path + "/",
                "make clean"]
